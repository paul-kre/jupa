    ...
    <div class="photo-and-text">
        <div class="left-small">
            <div class="photo-container">
                <div class="figure" style="background-image: url('<?php echo URL; ?>public/img/building_01.jpg');"></div>
            </div>
        </div>
        <div class="right-big">
            <div class="text">
...
<section class="text-mid">
    <h2>Die vergessene Schönheit des Bestandes ans Tageslicht zu bringen und diese mit der Moderne zu verbinden, ist die Essenz von Sanierung.</h2>
    <p>
...
<section class="full-size">
    <div class="big-photo">
        <div style="background-image: url('<?php echo URL; ?>public/img/living_room_01.jpg');" class="figure"></div>
    </div>
</section>
<section class="text-mid">
