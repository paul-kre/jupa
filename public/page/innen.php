    ...
    <div class="photo-and-text">
        <div class="left-small">
            <div class="photo-container">
                <div class="figure" style="background-image: url('<?php echo URL; ?>public/img/boy_01.jpg');"></div>
            </div>
        </div>
        <div class="right-big">
            <div class="text">
                <h1>Räume leben erst durch ihre Bewohner.</h1>
                <p>
                    Das Innen hat viele Facetten und hängt noch stärker als das Außen von den individuellen Bedürfnissen der Menschen ab. Wie wollen die Menschen wohnen? Familien, Singles oder ältere Menschen haben völlig andere Vorstellungen von ihren Räumen. Wichtig ist, eine Balance zu schaffen zwischen Orten des Rückzuges und des Außenkontaktes. Durch das kontinuierliche Gespräch mit meinen Auftraggebern kann ich deren Wünsche erfassen, sie im Entwurf sichtbar machen und in der Innenarchitektur umsetzen.
                </p>
            </div>
        </div>
    </div>
...
<section class="full-size">
    <div class="big-photo">
        <div style="background-image: url('<?php echo URL; ?>public/img/living_room_02.jpg');" class="figure"></div>
    </div>
</section>
...
<section class="full-size">
    <?php buildGallery("living_room_03", "chairs_a_01", array("chairs_b_01")); ?>
</section>
...
<section class="full-size">
    <?php buildGallery("living_room_04", "cabinet_01"); ?>
</section>
